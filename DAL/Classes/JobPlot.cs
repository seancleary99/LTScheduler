...
namespace DAL.Classes
{
    ...
    public class JobPlot
    {
        ...
        public string Plot { get { return _plot.PlotName; } set { _plot.PlotName = value; } }
        ...
        public JobPlot(int id, int plotId, int jobId, int houseType, int erectorId, int craneId, DateTime? prodDate, DateTime? onsiteDate, DateTime? compDate)
        {
